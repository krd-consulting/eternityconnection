...
<div id="wrapper_overall" class="<?php print $layout_type; ?> no-touch">
    ...
    <?php if ((isset($header_type) && $header_type != "full") || ($layout_type == "boxed")): ?>
...
//                print render($page['navigation']);
    ...
    <?php if (!empty($page['quotes'])): ?>
        <div class="quote_region">
    ...
    <?php if (!empty($page['tweets_area'])): ?>
        <div class="tweets_region">
            <div class="overlay"></div>
            <div class="container">
                <i class="ut-rq-icon-tw fa fa-twitter fa-2x"></i>
                <?php print render($page['tweets_area']); ?>
            </div>
        </div>
    <?php endif; ?>
