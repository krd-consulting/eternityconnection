...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://eternity:s0mething!@localhost/eternity_drupal?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://eternity:s0mething!@localhost/eternity_civicrm?new_link=true');
  }
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'https://www.eternityconnection.org/');
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '7aa6b80be29adfcc4ed16a96bd1739c1');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/drupal/eternity/sites/default/files/civicrm/templates_c//mail.log');
// }
